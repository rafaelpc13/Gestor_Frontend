...
const EliminarColaborador = () => {
    ...
    const { EliminarColaborador, handleEliminarColaborador,eliminarColaborador} = useProyectos()
                                    ...
                                    <Dialog.Title as="h3" className="text-lg leading-6 font-bold text-gray-900">
                                        ...
                                        <div className='mt-2'>
                                            <p className='text-sm text-gray-500'>
                                                Una vez Elimminado(a) no podra acceder a el Proyecto
                                            </p>
                                        </div>
                                    </Dialog.Title>
...
export default EliminarColaborador